 ...
 * </p>
 */
public class TestAAAA extends ViewGroup implements NestedScrollingParent,
     ...
     * @param context
     */
    public TestAAAA(@NonNull Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public TestAAAA(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public boolean canChildScrollUp() {
        ...
        boolean b = mTarget.canScrollVertically(-1);

        MyLog.d("canChildScrollUp::" + b);
    ...
    public void onNestedScrollAccepted(View child, View target, int axes) {
        ...
        MyLog.d("onNestedScrollAccepted::::::::" + target);
    }
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (mIsBeingDragged) {
                    ...
                    if (overscrollTop > 0) {
                        ...
                        MyLog.d("overscrollTop:::" + overscrollTop);
    ...
    public interface OnChildScrollUpCallback {
         ...
         */
        boolean canChildScrollUp(@NonNull TestAAAA parent, @Nullable View child);
    }
}
