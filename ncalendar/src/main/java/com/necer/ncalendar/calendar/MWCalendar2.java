...
public class MWCalendar2 extends LinearLayout implements NestedScrollingParent, OnMonthCalendarPageChangeListener, OnClickMonthCalendarListener, OnClickWeekCalendarListener, OnWeekCalendarPageChangeListener {
    ...
    public MWCalendar2(Context context) {
        this(context, null);
    }

    public MWCalendar2(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MWCalendar2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
